...
# how much of a model's own colour survives the game's doubled post brightness, per kind.
# Read from tour shots: Kenney's grey palette and Quaternius' pale bark went white at 0.4-0.5.
